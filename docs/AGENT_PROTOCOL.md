...
| `questions` | array | no | Questions needing operator input; displayed prominently in dashboard |
...
3. **Post status updates** at meaningful milestones: completing a subtask, hitting a blocker, opening a PR, or finishing a significant unit of work
